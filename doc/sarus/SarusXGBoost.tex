...
In order to sample from this distribution without numerical errors, we use the "racing trick" of \cite{medina2020}. It allows one
...
% TODO Need some schema : un pour le calcul distribué, un pour résumer les mécanismes 
